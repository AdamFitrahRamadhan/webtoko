  ...
  <body>
    <div class="log-w3">
      <div class="w3layouts-main">
         ...
         ?>
		       <form action="<?=base_url('index.php/kasir/proses_login')?>" method="post">
		    ...
		    <p>Tidak punya akun?<a href="<?=base_url('index.php/kasir/register')?>">Silahkan daftar</a></p>
      </div>
    </div>
